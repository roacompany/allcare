...
## P3-2
- [ ] **H-4 산부인과 전문의 수동 검토 대기** (예상 2주, 외부 의존): `.dev/qa-evidence/v2.8.0.md` + `BabyCare/Resources/pregnancy-weeks.json` 37주 콘텐츠 → 전문의 signoff (name/license/date). 완료 후 `[ ] PENDING` → `[V] SIGNED` + PLAN P3-2 체크 유지.
- [ ] Week 36 (파파야) / Week 22 (파파야) fruitSize 중복 — 전문의 검토 시 일관성 피드백 요청.
