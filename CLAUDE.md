...
### 즉시 (사용자 액션)
- [ ] TestFlight v2.6.0 빌드 (12커밋)
- [ ] LMS 데이터 스팟체크 (WHO 원본 CSV 대조)
- [ ] 카탈로그 상품 30~40개 등록 (admin /catalog)

### UX MEDIUM 14건
12-타이머 탭전환 무경고 | 13-기록수정 시간만 가능 | 14-이유식 칩중복 | 15-투약 칩패턴불일치 | 16-아기전환 대시보드만 | 17-지연접종 미정렬 | 18-이정표 필터0건 | 19-가족공유 설명부족 | 20-알레르기 기타입력불가 | 21-활동알림 설명모호 | 22-소형기기 뱃지잘림 | 23-병원비 포맷없음 | 24-건강탭 배너닫기불가 | 25-로딩상태 불일치
