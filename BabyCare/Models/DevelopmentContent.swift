...
extension DevelopmentCard {
    ...
    static let all: [DevelopmentCard] = [
        ...
        DevelopmentCard(
            ...
            category: .sleep,
            title: "6개월 밤중 수유 끊기",
            body: "생후 6개월이 지나면 대부분의 아기는 영양 측면에서 밤중 수유 없이도 충분히 자는 것이 가능합니다. 끊기 방법: ① 점진적 감소법—매 2~3일마다 수유량을 5~10ml씩 줄이거나 수유 시간을 줄여나가세요. ② 달래기 우선—울음이 시작되면 5~10분 후 접근해 수유 없이 토닥임, 노래로 재워보세요. ③ 취침 전 포만감 확보—마지막 수유를 넉넉하게 해주세요. 밤중 수유를 급격히 끊으면 스트레스가 크므로 2~3주의 여유를 두고 진행하세요. 낮 수유량은 충분히 유지해야 합니다.",
            monthRange: 5...8,
            emoji: "🌛"
        ),
        ...
        DevelopmentCard(
            ...
            category: .insight,
            title: "또래 평균 수유량 비교",
            body: "월령별 평균 수유량 가이드라인입니다. 신생아(0~1개월): 회당 60~90ml, 하루 8~12회. 2~3개월: 회당 120~150ml, 하루 6~8회. 4~6개월: 회당 150~200ml, 하루 5~6회. 6개월 이상(이유식 병행): 회당 150~180ml, 하루 4~5회. 단, 이 수치는 평균값이며 아기마다 차이가 큽니다. 중요한 것은 절대량보다 아기가 배고파하거나 과도하게 울지 않는지, 적절히 체중이 늘고 있는지 여부입니다. 걱정될 때는 소아과 의사와 상담하세요.",
            monthRange: 0...8,
            emoji: "🍼"
        ),
