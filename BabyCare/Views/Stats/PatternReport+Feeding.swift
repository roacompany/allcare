...
extension PatternReportView {
    ...
    // MARK: - Feeding Sub-views

    @ViewBuilder
    private func feedingSummaryStats(_ f: FeedingPattern) -> some View {
        HStack(spacing: 0) {
    ...
    @ViewBuilder
    private func feedingDailyChart(_ f: FeedingPattern) -> some View {
    ...
    @ViewBuilder
    private func feedingPeakHours(_ f: FeedingPattern) -> some View {
    ...
    @ViewBuilder
    private func feedingMetrics(_ f: FeedingPattern) -> some View {
