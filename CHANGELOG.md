...
## [2.8.8] - Unreleased (main 빌드 98 committed — App Store 미제출)

> **TestFlight 빌드 98(2026-07-10) = 이 버전의 첫 main 빌드**(#30~#54 전체 포함). 빌드 93/94는 `tf/pregnancy-v3-test` 브랜치(임신 v3 flag-on QA 전용, #49~#54 미포함), 95~97은 쿠팡식 실험 워크트리가 소비. 2.8.8 제출 시 미출시 2.8.7 내용도 함께 출시된다. 임신 v3는 컴파일 flag-off 휴면(사용자 노출 0).
