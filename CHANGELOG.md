...
## [2.8.8] - Unreleased (TestFlight 빌드 103 — App Store 미제출)

> **TestFlight 빌드 103(2026-07-12) = #30~#73 + 기록하기 통합 재설계 + 유축 재고**. 빌드 99=#30~#73, 100~102=재설계 QA 빌드. 빌드 93/94는 `tf/pregnancy-v3-test`(임신 v3 flag-on QA 전용), 95~97은 쿠팡식 실험 워크트리가 소비. 2.8.8 제출 시 미출시 2.8.7 내용도 함께 출시된다. 임신 v3는 컴파일 flag-off 휴면(사용자 노출 0).
